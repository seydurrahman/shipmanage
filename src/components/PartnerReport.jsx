...
const PartnerReport = () => {
  ...
  const calculateNetProfit = (shipId) => {
    ...
    // Calculate totals (use actual_amount when available)
    ...
    console.log(
      "Total Income (actual_amount) for ship",
      shipId,
      ":",
      totalIncome
    );

    const totalExpense = shipExpenses.reduce(
                      ...
                      <tbody>
                        {shipPartners.map((partner) => {
                          ...
                          const payableAmount =
                            ...
                            parseFloat(partner.share_amount || 0);
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="border px-4 py-2 text-right">
                                Tk{" "}
                                {parseFloat(partner.share_amount || 0).toFixed(
                                  2
                                )}
                              </td>
